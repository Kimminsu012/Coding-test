...
let info ={ 
    ...
    151 : { name:"김유신", job:"군인", 활동지:"경주" } ,
    128 : { name:"장보고", job:"군인", 활동지:"진도" } ,
...
function list_print(){ // 객체에 저장된 value(데이터)를 출력하는 함수
    ...
    // 객체의 value만 추출하는 방법 - Object.values(객채명);
    ...
    // alert( info_keys );
    // alert(info[101].name + "  " + info[101].job);
}
...
function save(){ // 저장 버튼 클릭 시 동작할 함수
    ...
    var out = "";
    for(var object of list){ // 배열이 가진 값을 넘겨주는거 , in - 인덱스를 넘겨줌
